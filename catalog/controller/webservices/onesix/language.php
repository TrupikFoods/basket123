...
class ControllerWebServicesOneSixlanguage extends Controller {
	...
	$data['app_text_add_to_wishlist'] = iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_add_to_wishlist'));    
        ...
        $data['app_text_your_wishlist_is_empty'] = iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_your_wishlist_is_empty')); 
         ...
         $data["app_text_related_products"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_related_products')); 
        $data["app_text_view_reviews"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_view_reviews')); 
        $data["app_text_write_reviews"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_write_reviews')); 
        $data[ "app_text_please_fill_all_details"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_please_fill_all_details')); 
        $data["app_text_close"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_close')); 
        $data["app_text_add_review"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_add_review')); 
        $data["app_text_write_a_review"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_write_a_review')); 
        $data["app_text_name"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_name')); 
        $data["app_text_nick"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_name')); 
        $data["app_text_title"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_title')); 
        $data["app_text_no_reviews"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_no_reviews')); 
        $data["app_text_number_of_reviews"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_number_of_reviews')); 
        $data["app_text_minimum_rating"]=iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_minimum_rating')); 
        $data["app_text_error"] =iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_error')); 
        $data["app_text_no_reviews"] =iconv("UTF-8","UTF-8//IGNORE",$this->language->get('app_text_no_reviews')); 
