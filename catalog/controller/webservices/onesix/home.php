            ...
            if($i<$number_of_products) {
                ...
                if ($productInfo) {
                    ...
                    $products[$i] = array(
                        ...
                        'has_attributes' => $this->isOptions($productInfo['product_id']),
                        'cart_quantity' => $this->getCartQuantity($productInfo['product_id']),
                        'number_of_reviews' => $this->getNumberOfRating($productInfo['product_id']),
                        'averagecomments' => $this->getRating($productInfo['product_id']),
