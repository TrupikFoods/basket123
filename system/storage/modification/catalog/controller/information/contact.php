...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$replace = array($this->request->post['name'],$this->request->post['phone'],$this->request->post['email'],$this->request->post['enquiry'],$this->config->get('config_name'));
		$this->model_extension_module_smsalert->parseSMS('contact_form', $this->config->get('config_store_id'), $this->request->post['phone'], $replace);
