		...
		if ($order_info) {
			...
			$content = '<form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="template" id="input-template" class="form-control">'.$this->model_extension_module_smsalert->getSmsTemplate().'
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="SmsSmscontent">Message</label>
                  <div class="col-sm-10">
                    <textarea name="message" rows="8" id="SmsSmscontent" class="form-control"></textarea>
                  </div>
                </div>
				 <div class="small sms_counter text-right">
		  <span class="left"><span id="count" >0</span> Character(s)</span>
		  <span class="right"><span id="smscount">0</span> SMS</span>
	  </div>
				<p></p>
              </form></fieldset><div class="col-sm-2"></div><div class="col-sm-10"><div class="text-left">
              <button id="button-smsalert" class="btn btn-primary" onclick="sendSms()"><i class="fa fa-paper-plane"></i> Send</button></div>
            </div>';
		     $data['tabs'][] = array(
							'code'    => 'smsalert',
							'title'   => 'Custom SMS',
