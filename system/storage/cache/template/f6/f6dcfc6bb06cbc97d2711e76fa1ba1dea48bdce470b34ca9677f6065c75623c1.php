...
/* basel/template/information/sitemap.twig */
class __TwigTemplate_db7c223e4453edff223571605f20c3f9626253eaf01be2bad4225c7b6dd2df22 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">";
    ...
    ";
      ...
      <div class=\"row\">
        ...
        // line 59
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["information"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["informations"]) {
            // line 60
            echo "                <li><a href=\"";
            echo twig_get_attribute($this->env, $this->source, ($context["information"] ?? null), "href", [], "any", false, false, false, 60);
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, ($context["information"] ?? null), "title", [], "any", false, false, false, 60);
            echo "</a></li>
                ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return "basel/template/information/sitemap.twig";
    }
    ...
    {
        return new Source("", "basel/template/information/sitemap.twig", "");
    }
}
